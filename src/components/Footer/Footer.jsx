...
const Footer = ({ theme }) => {
  return (
    <footer className="pb-20">
      ...
      <ul>
        <li> 
          <a className="font-VisbyMed uppercase text-3xl md:text-[70px] leading-snug flex item-center gap-4 group" href="mailto: shirin.forouzan@yahoo.com"><span className="hidden group-hover:block">
