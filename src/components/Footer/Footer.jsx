    ...
    <footer className="pb-20">
      ...
      <ul>
        <li> 
          ...
          <span className="pl-0 group-hover:pl-[30px] md:group-hover:pl-[70px] sm:group-hover:pl-[60px] transition-all duration-[300ms]">Email</span></a>
        </li>
        <li>
          ...
          <span className="pl-0 group-hover:pl-[30px] md:group-hover:pl-[70px] sm:group-hover:pl-[60px] transition-all duration-[300ms]">Linkedin</span></a>
        </li>
      </ul>
    </footer>
  )
