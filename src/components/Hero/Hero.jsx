  ...
  return (
    <section className="md:h-[80vh] flex flex-col justify-end md:mb-40">
      <div className="pt-20 md:pt-0">
        ...
        <h2 className="mb-[60px] select-none font-DMSans text-[22px] md:mb-0 md:text-heroSub leading-tight text-center md:text-center pt-1 md:pt-0">
          UX/UI & GRAPHIC DESIGNER.
        </h2>
        {/* <p className="select-none font-DMSans text-[20px] leading-tight text-center md:text-center pt-1 md:pt-0">This portfolio site is under construction!🚧⚠️</p> */}
      </div>
    </section>
  );
};
